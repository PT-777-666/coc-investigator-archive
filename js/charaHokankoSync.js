 ...
 * (https://charasheet.vampire-blood.net/help/kiyaku、2026-09-10確認)には「バックアップは
 * 取っていません。URLに『.js』をつけるとJavaScriptで保存できます」とあり、利用者自身が
 * この.js出力で保存することは公式に案内された使い方である。同ページが禁止しているのは
 * 「ルルブ(ルールブック)の全データ転載」(「持ってなくても簡単にできるよ」系の行為)で
 * あって、本人が自分のキャラクター1件を.js出力でバックアップする用途とは別種の行為である。
 *
